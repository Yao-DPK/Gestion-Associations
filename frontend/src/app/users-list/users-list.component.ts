...
export class UsersListComponent implements OnInit {
  displayedColumns: string[] = ['id', 'lastname', 'firstname', 'age','members'];
  dataSource = users;
...
Update(id:string){
  ...
  let data = {firstname: this.firstname,lastname: this.lastname, age: this.age, password:this.password, idUsers:this.idUsers}
